CREATE TABLE [Salon].[MSSQL_TemporalHistoryFor_1963154039_F493DFCB] (
...
GO
CREATE CLUSTERED INDEX [ix_MSSQL_TemporalHistoryFor_1963154039_F493DFCB]
    ON [Salon].[MSSQL_TemporalHistoryFor_1963154039_F493DFCB]([Wpis_Do] ASC, [Wpis_Od] ASC) WITH (DATA_COMPRESSION = PAGE);
